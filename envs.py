...
import logging
from core import Wrapper, ObservationWrapper
from vectorize import  Unvectorize, Vectorize
...
def DiagnosticsInfo(env, *args, **kwargs):
    return VectorizeFilter(env, DiagnosticsInfoI, *args, **kwargs)

class DiagnosticsInfoI(Filter):
